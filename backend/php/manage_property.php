                ...
                <form id="editForm" action="">
                    ...
                    <div id="property">
                        <div id="info">
                            <div id="houseMainInfo">
                                ...
                                <select id="property_state" class="select">
                            ...
                            <div id="houseArea">
                                <div id="number-of-rooms-section" class="houseAreaSections">
                                    <label for="number_of_rooms" class="label">Number of rooms: </label>
                            ...
                            <div id="number-of-bathrooms-section" class="houseAreaSections">
                                <label for="number_of_bathrooms" class="label">Number of bathrooms:</label>
                                <input id="number_of_bathrooms" class="inputValue" type="number" step="0.5" min="0"
                                    max="9999999999.99" data-previous_content="">
                            </div>
                            <div id="area-sqft-section" class="houseAreaSections">
                                <label for="area_sqft" class="label">Building area (sqft)</label>
                    ...
                    <div id="houseAddress">
                        <div class="address-item">
                            ...
                            <input id="address_street" data-previous_content="" type="text">
                        </div>
                        <div class="address-item">
                        ...
                        <div class="address-item">
                            ...
                            <input id="address_city" data-previous_content="" type="text">
                        </div>
                        <div class="address-item">
                            <label for="address_state" class="label">State: </label>
                            <input id="address_state" data-previous_content="" type="text">
                        </div>
                        <div class="address-item">
                    ...
                    <div id="descriptionContainer">
                        <div id="description_label" class="label">Description: </div>
                        <textarea id="description" data-previous_content=""></textarea>
                    </div>
                    <div id="webData">
                    ...
                    <div id="features">
                        <div class="two-column-container">
                            ...
                            <div class="column" id="propertyFacts">
                                <div class="field-row">
                                    <label for="levels" class="label">Number of levels:</label>
                                    <input id="levels" class="inputValue" type="number" step="1" min="0"
                                        max="9999999999.99" data-previous_content="">
                                </div>
                                <div class="field-row">
                                    <label for="parcel_number" class="label">Parcel number:</label>
                                    <input id="parcel_number" data-previous_content="" type="text">
                                </div>
                                <div class="field-row">
                                ...
                                <div class="field-row">
                                    <label for="size_lot" class="label">Lot size:</label>
                        ...
                        <div class="two-column-container">
                            <div class="column" id="construction">
                                <div class="field-row">
                                    <label for="built_in_year" class="label">Built in year:</label>
                                    <input id="built_in_year" class="inputValue" type="number" step="1" min="0"
                                        max="9999999999.99" data-previous_content="">
                                </div>
                                <div class="field-row">
                                    <label for="home_type" class="label">Home type:</label>
                                    <input id="home_type" data-previous_content="" type="text">
                                </div>
                                <div class="field-row">
